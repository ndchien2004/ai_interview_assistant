  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#fff8e8] text-foreground dark:bg-background">
      ...
      <section className="relative z-10 flex min-h-screen items-center px-5 py-8 sm:px-8 lg:px-16">
        <div className="w-full max-w-[590px] rotate-[1deg] rounded-md border-2 border-[#172018] bg-white px-6 py-5 shadow-[10px_10px_0_#172018] dark:border-white/85 dark:bg-card dark:shadow-[10px_10px_0_rgba(255,255,255,0.24)] sm:px-8 sm:py-6">
          <Link href="/" className="mb-5 inline-flex items-center gap-2 rounded-full border-2 border-[#172018] bg-[#fef08a] px-3 py-2 text-sm font-extrabold tracking-tight text-[#172018] shadow-[4px_4px_0_#172018] dark:border-white/85">
