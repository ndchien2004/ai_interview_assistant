...
export function AppShell({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-6">
        <div className="text-center">
          <div className="mx-auto mb-4 size-10 animate-pulse rounded-lg bg-primary/15" />
  ...
  return (
    <div className="min-h-screen bg-[#f6f7f3] text-foreground">
      <aside
        className={cn(
      ...
      >
        ...
        <div className="absolute inset-x-4 bottom-5 rounded-lg border border-border bg-muted/40 p-3">
        ...
        <header className="sticky top-0 z-20 border-b border-border bg-background/90 backdrop-blur">
          <div className="flex h-16 items-center justify-between px-4 sm:px-6">
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <span className="flex size-9 items-center justify-center rounded-full bg-emerald-100 text-sm font-semibold text-emerald-800">
